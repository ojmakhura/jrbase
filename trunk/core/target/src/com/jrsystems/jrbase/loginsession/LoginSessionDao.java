...
public interface LoginSessionDao
{
     ...
     * {@link com.jrsystems.jrbase.loginsession.vo.LoginSessionVO}.
     */
    public final static int TRANSFORM_LOGINSESSIONVO = 1;

    /**
     * Copies the fields of the specified entity to the target value object. This method is similar to
     * toLoginSessionVO(), but it does not handle any attributes in the target
    ...
    /**
     * Converts this DAO's entity to an object of type {@link com.jrsystems.jrbase.loginsession.vo.LoginSessionVO}.
     */
    public com.jrsystems.jrbase.loginsession.vo.LoginSessionVO toLoginSessionVO(com.jrsystems.jrbase.loginsession.LoginSession entity);

    /**
     * Converts this DAO's entity to a Collection of instances of type {@link com.jrsystems.jrbase.loginsession.vo.LoginSessionVO}.
     */
    public void toLoginSessionVOCollection(java.util.Collection entities);

    /**
     * Converts this DAO's entity to an array of instances of type {@link com.jrsystems.jrbase.loginsession.vo.LoginSessionVO}.
     */
    public com.jrsystems.jrbase.loginsession.vo.LoginSessionVO[] toLoginSessionVOArray(java.util.Collection entities);

    /**
     * Copies the fields of {@link com.jrsystems.jrbase.loginsession.vo.LoginSessionVO} to the specified entity.
    ...
    /**
     * Converts an instance of type {@link com.jrsystems.jrbase.loginsession.vo.LoginSessionVO} to this DAO's entity.
     */
    ...
    /**
     * Converts a Collection of instances of type {@link com.jrsystems.jrbase.loginsession.vo.LoginSessionVO} to this
     * DAO's entity.
     */
    public void loginSessionVOToEntityCollection(java.util.Collection instances);

    /**
     * Loads an instance of com.jrsystems.jrbase.loginsession.LoginSession from the persistent store.
     */
    ...
    /**
     * Loads all entities of type {@link com.jrsystems.jrbase.loginsession.LoginSession}.
     *
    ...
    /**
     * Creates an instance of com.jrsystems.jrbase.loginsession.LoginSession and adds it to the persistent store.
     */
    public com.jrsystems.jrbase.loginsession.LoginSession create(com.jrsystems.jrbase.loginsession.LoginSession loginSession);

    /**
     * <p>
     * Does the same thing as {@link #create(com.jrsystems.jrbase.loginsession.LoginSession)} with an
     * additional flag called <code>transform</code>. If this flag is set to <code>TRANSFORM_NONE</code> then
     * the returned entity will <strong>NOT</strong> be transformed. If this flag is any of the other constants
     * defined here then the result <strong>WILL BE</strong> passed through an operation which can optionally
     * transform the entity (into a value object for example). By default, transformation does
     ...
     * </p>
     */
    public Object create(int transform, com.jrsystems.jrbase.loginsession.LoginSession loginSession);

    /**
     * Creates a new instance of com.jrsystems.jrbase.loginsession.LoginSession and adds
     * from the passed in <code>entities</code> collection
     *
     * @param entities the collection of com.jrsystems.jrbase.loginsession.LoginSession
     * instances to create.
     *
    ...
    /**
     * <p>
     * Creates a new <code>com.jrsystems.jrbase.loginsession.LoginSession</code>
    ...
    /**
     * Updates the <code>loginSession</code> instance in the persistent store.
     */
    ...
    /**
     * Removes the instance of com.jrsystems.jrbase.loginsession.LoginSession from the persistent store.
     */
    public void remove(com.jrsystems.jrbase.loginsession.LoginSession loginSession);

    /**
     * Removes the instance of com.jrsystems.jrbase.loginsession.LoginSession having the given
     ...
     * 
     */
    public java.util.List findByCriteria(com.jrsystems.jrbase.loginsession.vo.LoginSearchCriteria searchCriteria);
