...
{
    private com.jrsystems.jrbase.workbench.program.service.ProgramService programService;
    ...
    public com.jrsystems.jrbase.workbench.program.vo.ProgramVO saveProgram(com.jrsystems.jrbase.workbench.program.vo.ProgramVO programVO)
    {
        ...
        try
        {
            return this.programService.saveProgram(programVO);
        }
        catch (Exception exception)
        {
            final Throwable cause = getRootCause(exception);
    ...
    public void removeProgram(com.jrsystems.jrbase.workbench.program.vo.ProgramVO programVo)
    {
        ...
        try
        {
            this.programService.removeProgram(programVo);
        }
        catch (Exception exception)
        {
            final Throwable cause = getRootCause(exception);
    ...
    {
        this.programService = (com.jrsystems.jrbase.workbench.program.service.ProgramService)
            getBeanFactory().getBean("programService");
    }
