...
public interface MenuDao
{
     ...
     * {@link com.jrsystems.jrbase.workbench.menu.vo.MenuVO}.
     */
    public final static int TRANSFORM_MENUVO = 1;

    /**
     * Copies the fields of the specified entity to the target value object. This method is similar to
     * toMenuVO(), but it does not handle any attributes in the target
    ...
    /**
     * Converts this DAO's entity to an object of type {@link com.jrsystems.jrbase.workbench.menu.vo.MenuVO}.
     */
    public com.jrsystems.jrbase.workbench.menu.vo.MenuVO toMenuVO(com.jrsystems.jrbase.workbench.menu.Menu entity);

    /**
     * Converts this DAO's entity to a Collection of instances of type {@link com.jrsystems.jrbase.workbench.menu.vo.MenuVO}.
     */
    public void toMenuVOCollection(java.util.Collection entities);

    /**
     * Converts this DAO's entity to an array of instances of type {@link com.jrsystems.jrbase.workbench.menu.vo.MenuVO}.
     */
    public com.jrsystems.jrbase.workbench.menu.vo.MenuVO[] toMenuVOArray(java.util.Collection entities);

    /**
     * Copies the fields of {@link com.jrsystems.jrbase.workbench.menu.vo.MenuVO} to the specified entity.
    ...
    /**
     * Converts an instance of type {@link com.jrsystems.jrbase.workbench.menu.vo.MenuVO} to this DAO's entity.
     */
    public com.jrsystems.jrbase.workbench.menu.Menu menuVOToEntity(com.jrsystems.jrbase.workbench.menu.vo.MenuVO menuVO);

    /**
     * Converts a Collection of instances of type {@link com.jrsystems.jrbase.workbench.menu.vo.MenuVO} to this
     * DAO's entity.
     */
    public void menuVOToEntityCollection(java.util.Collection instances);

    /**
     * Loads an instance of com.jrsystems.jrbase.workbench.menu.Menu from the persistent store.
     */
    ...
    /**
     * Loads all entities of type {@link com.jrsystems.jrbase.workbench.menu.Menu}.
     *
    ...
    /**
     * Creates an instance of com.jrsystems.jrbase.workbench.menu.Menu and adds it to the persistent store.
     */
    public com.jrsystems.jrbase.workbench.menu.Menu create(com.jrsystems.jrbase.workbench.menu.Menu menu);

    /**
     * <p>
     * Does the same thing as {@link #create(com.jrsystems.jrbase.workbench.menu.Menu)} with an
     * additional flag called <code>transform</code>. If this flag is set to <code>TRANSFORM_NONE</code> then
     * the returned entity will <strong>NOT</strong> be transformed. If this flag is any of the other constants
     * defined here then the result <strong>WILL BE</strong> passed through an operation which can optionally
     * transform the entity (into a value object for example). By default, transformation does
     ...
     * </p>
     */
    public Object create(int transform, com.jrsystems.jrbase.workbench.menu.Menu menu);

    /**
     * Creates a new instance of com.jrsystems.jrbase.workbench.menu.Menu and adds
     * from the passed in <code>entities</code> collection
     *
     * @param entities the collection of com.jrsystems.jrbase.workbench.menu.Menu
     * instances to create.
     *
    ...
    /**
     * <p>
     * Creates a new <code>com.jrsystems.jrbase.workbench.menu.Menu</code>
    ...
    /**
     * Updates the <code>menu</code> instance in the persistent store.
     */
    ...
    /**
     * Removes the instance of com.jrsystems.jrbase.workbench.menu.Menu from the persistent store.
     */
    public void remove(com.jrsystems.jrbase.workbench.menu.Menu menu);

    /**
     * Removes the instance of com.jrsystems.jrbase.workbench.menu.Menu having the given
     ...
     * 
     */
    public java.util.List findByCriteria(com.jrsystems.jrbase.workbench.menu.vo.MenuSearchCriteria criteria);
