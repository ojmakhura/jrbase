    ...
    implements java.io.Serializable
{
    ...
    private java.util.Collection parameters = new java.util.ArrayList();
    ...
    {
        return (SearchParameter[]) this.parameters.toArray(new SearchParameter[0]);
    }
    ...
    {
        this.parameters = new java.util.ArrayList(java.util.Arrays.asList(parameters));
        return this;
    }
