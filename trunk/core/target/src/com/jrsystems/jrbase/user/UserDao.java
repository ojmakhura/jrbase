...
public interface UserDao
{
     ...
     * {@link com.jrsystems.jrbase.user.vo.UserVO}.
     */
    ...
    /**
     * Converts this DAO's entity to an object of type {@link com.jrsystems.jrbase.user.vo.UserVO}.
     */
    public com.jrsystems.jrbase.user.vo.UserVO toUserVO(com.jrsystems.jrbase.user.User entity);

    /**
     * Converts this DAO's entity to a Collection of instances of type {@link com.jrsystems.jrbase.user.vo.UserVO}.
     */
    public void toUserVOCollection(java.util.Collection entities);

    /**
     * Converts this DAO's entity to an array of instances of type {@link com.jrsystems.jrbase.user.vo.UserVO}.
     */
    public com.jrsystems.jrbase.user.vo.UserVO[] toUserVOArray(java.util.Collection entities);

    /**
     * Copies the fields of {@link com.jrsystems.jrbase.user.vo.UserVO} to the specified entity.
    ...
    /**
     * Converts an instance of type {@link com.jrsystems.jrbase.user.vo.UserVO} to this DAO's entity.
     */
    public com.jrsystems.jrbase.user.User userVOToEntity(com.jrsystems.jrbase.user.vo.UserVO userVO);

    /**
     * Converts a Collection of instances of type {@link com.jrsystems.jrbase.user.vo.UserVO} to this
     * DAO's entity.
     */
    public void userVOToEntityCollection(java.util.Collection instances);

    /**
     * Loads an instance of com.jrsystems.jrbase.user.User from the persistent store.
     */
    ...
    /**
     * Loads all entities of type {@link com.jrsystems.jrbase.user.User}.
     *
    ...
    /**
     * Creates an instance of com.jrsystems.jrbase.user.User and adds it to the persistent store.
     */
    public com.jrsystems.jrbase.user.User create(com.jrsystems.jrbase.user.User user);

    /**
     * <p>
     * Does the same thing as {@link #create(com.jrsystems.jrbase.user.User)} with an
     * additional flag called <code>transform</code>. If this flag is set to <code>TRANSFORM_NONE</code> then
     * the returned entity will <strong>NOT</strong> be transformed. If this flag is any of the other constants
     * defined here then the result <strong>WILL BE</strong> passed through an operation which can optionally
     * transform the entity (into a value object for example). By default, transformation does
     ...
     * </p>
     */
    public Object create(int transform, com.jrsystems.jrbase.user.User user);

    /**
     * Creates a new instance of com.jrsystems.jrbase.user.User and adds
     * from the passed in <code>entities</code> collection
     *
     * @param entities the collection of com.jrsystems.jrbase.user.User
     * instances to create.
     *
    ...
    /**
     * <p>
     * Creates a new <code>com.jrsystems.jrbase.user.User</code>
    ...
    /**
     * <p>
     * Does the same thing as {@link #create(byte[], com.jrsystems.jrbase.user.UserStatus, java.lang.String, java.lang.String, java.lang.String, java.lang.String)} with an
     * additional flag called <code>transform</code>. If this flag is set to <code>TRANSFORM_NONE</code> then
     * the returned entity will <strong>NOT</strong> be transformed. If this flag is any of the other constants
     * defined here then the result <strong>WILL BE</strong> passed through an operation which can optionally
     * transform the entity (into a value object for example). By default, transformation does
    ...
    /**
     * <p>
     * Does the same thing as {@link #create(com.jrsystems.jrbase.user.UserStatus, java.lang.String, java.lang.String, java.lang.String)} with an
     * additional flag called <code>transform</code>. If this flag is set to <code>TRANSFORM_NONE</code> then
     * the returned entity will <strong>NOT</strong> be transformed. If this flag is any of the other constants
     * defined here then the result <strong>WILL BE</strong> passed through an operation which can optionally
     * transform the entity (into a value object for example). By default, transformation does
    ...
    /**
     * Removes the instance of com.jrsystems.jrbase.user.User from the persistent store.
     */
    public void remove(com.jrsystems.jrbase.user.User user);

    /**
     * Removes the instance of com.jrsystems.jrbase.user.User having the given
     ...
     * 
     */
    public java.util.List findByCriteria(com.jrsystems.jrbase.user.vo.UserSearchCriteria searchCriteria);
