 ...
 */
public class ClearanceLevelServiceBean
...
{
    private com.jrsystems.jrbase.clearancelevel.service.ClearanceLevelService clearanceLevelService;
    ...
    public com.jrsystems.jrbase.clearancelevel.vo.ClearanceLevelVO saveClearanceLevel(com.jrsystems.jrbase.clearancelevel.vo.ClearanceLevelVO clearanceLevelVO)
    {
        ...
        try
        {
            return this.clearanceLevelService.saveClearanceLevel(clearanceLevelVO);
        }
    ...
    public java.util.List getAllClearanceLevels()
    {
        ...
        try
        {
            return this.clearanceLevelService.getAllClearanceLevels();
        }
        catch (Exception exception)
        {
            final Throwable cause = getRootCause(exception);
    ...
    public void removeClearanceLevel(com.jrsystems.jrbase.clearancelevel.vo.ClearanceLevelVO clearanceLevelVo)
    {
        ...
        try
        {
            this.clearanceLevelService.removeClearanceLevel(clearanceLevelVo);
        }
        catch (Exception exception)
        {
            final Throwable cause = getRootCause(exception);
    ...
    {
        this.clearanceLevelService = (com.jrsystems.jrbase.clearancelevel.service.ClearanceLevelService)
            getBeanFactory().getBean("clearanceLevelService");
    }
