...
public interface RoleDao
{
     ...
     * {@link com.jrsystems.jrbase.role.vo.RoleVO}.
     */
    public final static int TRANSFORM_ROLEVO = 1;
    ...
    /**
     * Converts this DAO's entity to an object of type {@link com.jrsystems.jrbase.role.vo.RoleVO}.
     */
    public com.jrsystems.jrbase.role.vo.RoleVO toRoleVO(com.jrsystems.jrbase.role.Role entity);

    /**
     * Converts this DAO's entity to a Collection of instances of type {@link com.jrsystems.jrbase.role.vo.RoleVO}.
     */
    public void toRoleVOCollection(java.util.Collection entities);

    /**
     * Converts this DAO's entity to an array of instances of type {@link com.jrsystems.jrbase.role.vo.RoleVO}.
     */
    public com.jrsystems.jrbase.role.vo.RoleVO[] toRoleVOArray(java.util.Collection entities);

    /**
     * Copies the fields of {@link com.jrsystems.jrbase.role.vo.RoleVO} to the specified entity.
    ...
    /**
     * Converts an instance of type {@link com.jrsystems.jrbase.role.vo.RoleVO} to this DAO's entity.
     */
    public com.jrsystems.jrbase.role.Role roleVOToEntity(com.jrsystems.jrbase.role.vo.RoleVO roleVO);

    /**
     * Converts a Collection of instances of type {@link com.jrsystems.jrbase.role.vo.RoleVO} to this
     * DAO's entity.
     */
    public void roleVOToEntityCollection(java.util.Collection instances);

    /**
     * Loads an instance of com.jrsystems.jrbase.role.Role from the persistent store.
     */
    ...
    /**
     * Loads all entities of type {@link com.jrsystems.jrbase.role.Role}.
     *
    ...
    /**
     * Creates an instance of com.jrsystems.jrbase.role.Role and adds it to the persistent store.
     */
    public com.jrsystems.jrbase.role.Role create(com.jrsystems.jrbase.role.Role role);

    /**
     * <p>
     * Does the same thing as {@link #create(com.jrsystems.jrbase.role.Role)} with an
     * additional flag called <code>transform</code>. If this flag is set to <code>TRANSFORM_NONE</code> then
     * the returned entity will <strong>NOT</strong> be transformed. If this flag is any of the other constants
     * defined here then the result <strong>WILL BE</strong> passed through an operation which can optionally
     * transform the entity (into a value object for example). By default, transformation does
     ...
     * </p>
     */
    public Object create(int transform, com.jrsystems.jrbase.role.Role role);

    /**
     * Creates a new instance of com.jrsystems.jrbase.role.Role and adds
     * from the passed in <code>entities</code> collection
     *
     * @param entities the collection of com.jrsystems.jrbase.role.Role
     * instances to create.
     *
    ...
    /**
     * <p>
     * Creates a new <code>com.jrsystems.jrbase.role.Role</code>
    ...
    /**
     * Updates the <code>role</code> instance in the persistent store.
     */
    ...
    /**
     * Removes the instance of com.jrsystems.jrbase.role.Role from the persistent store.
     */
    public void remove(com.jrsystems.jrbase.role.Role role);

    /**
     * Removes the instance of com.jrsystems.jrbase.role.Role having the given
     ...
     * 
     */
    public java.util.List findByCriteria(com.jrsystems.jrbase.role.vo.RoleSearchCriteria searchCriteria);
