<!-- Generated by pages/error-page.jsp.vsl in cartridge andromda-bpm4struts -->
...
--%>
    ...
    <body>
        <div id="error">
            ...
            <c:set var="link"><html:rewrite page="/index.jsp"/></c:set>
            <div id="link">
               <html:link href="${link}" titleKey="error.link.title">
