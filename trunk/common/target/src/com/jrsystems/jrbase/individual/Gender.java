    ...
    implements java.io.Serializable, java.lang.Comparable
{
     ...
     */
    private static final long serialVersionUID = 2270621832096208816L;
    ...
    private Gender(java.lang.String value)
    {
        this.value = value;
    }
    ...
    /**
     * Creates an instance of Gender from <code>value</code>.
     *
     * @param value the value to create the Gender from.
     */
    public static Gender fromString(java.lang.String value)
    {
        final Gender typeValue = (Gender)values.get(value);
        if (typeValue == null)
        {
    ...
    {
        return (this == that) ? 0 : this.getValue().compareTo(((Gender)that).getValue());
    }
    ...
    {
        return (this == object)
            || (object instanceof Gender && ((Gender)object).getValue().equals(
                this.getValue()));
    }
    ...
    {
        return Gender.fromString(this.value);
    }
    ...
    static
    {
        values.put(MALE.value, MALE);
        valueList.add(MALE);
        literals.add(MALE.value);
        names.add("MALE");
        values.put(FEMALE.value, FEMALE);
        valueList.add(FEMALE);
        literals.add(FEMALE.value);
        names.add("FEMALE");
