    ...
    implements java.io.Serializable
{
     ...
     */
    private static final long serialVersionUID = -5525700460894590776L;

    public LocationSearchCriteria()
    {
    }

    public LocationSearchCriteria(com.jrsystems.jrbase.location.LocationStatus status, com.jrsystems.jrbase.location.vo.LocationTypeVO locationTypeVO, String locationName, java.lang.String uniqueCode, String levelCode)
    {
        this.status = status;
    ...
    public LocationSearchCriteria(com.jrsystems.jrbase.location.LocationStatus status, com.jrsystems.jrbase.location.vo.LocationTypeVO locationTypeVO, String description, String locationName, java.lang.String uniqueCode, String levelCode)
    {
        this.status = status;
        this.locationTypeVO = locationTypeVO;
    ...
    /**
     * Copies constructor from other LocationSearchCriteria
     *
     * @param otherBean, cannot be <code>null</code>
     * @throws java.lang.NullPointerException if the argument is <code>null</code>
     */
    public LocationSearchCriteria(LocationSearchCriteria otherBean)
    {
        this(otherBean.getStatus(), otherBean.getLocationTypeVO(), otherBean.getDescription(), otherBean.getLocationName(), otherBean.getUniqueCode(), otherBean.getLevelCode());
    }

    /**
     * Copies all properties from the argument value object into this value object.
     */
    public void copy(LocationSearchCriteria otherBean)
    {
        if (otherBean != null)
        {
    ...
    // com.jrsystems.jrbase.location.vo.LocationSearchCriteria value-object java merge-point
}