    ...
    implements java.io.Serializable, java.lang.Comparable
{
     ...
     */
    private static final long serialVersionUID = -5518803877101287806L;

    /**
     * 
     */
    public static final LocationStatus CLOSED = new LocationStatus("CLOSED");

    /**
     * 
     */
    public static final LocationStatus OPEN = new LocationStatus("OPEN");

    /**
     * 
     */
    public static final LocationStatus DEMOLISHED = new LocationStatus("DEMOLISHED");

    private java.lang.String value;

    private LocationStatus(java.lang.String value)
    {
        this.value = value;
    }
    ...
    /**
     * Creates an instance of LocationStatus from <code>value</code>.
     *
     * @param value the value to create the LocationStatus from.
     */
    public static LocationStatus fromString(java.lang.String value)
    {
        final LocationStatus typeValue = (LocationStatus)values.get(value);
        if (typeValue == null)
        {
    ...
    {
        return (this == that) ? 0 : this.getValue().compareTo(((LocationStatus)that).getValue());
    }
    ...
    {
        return (this == object)
            || (object instanceof LocationStatus && ((LocationStatus)object).getValue().equals(
                this.getValue()));
    }
    ...
    {
        return LocationStatus.fromString(this.value);
    }

    private static final java.util.Map values = new java.util.LinkedHashMap(3, 1);
    ...
    private static java.util.List valueList = new java.util.ArrayList(3);
    ...
    static
    {
        ...
        names.add("OPEN");
        values.put(DEMOLISHED.value, DEMOLISHED);
        valueList.add(DEMOLISHED);
        literals.add(DEMOLISHED.value);
        names.add("DEMOLISHED");
