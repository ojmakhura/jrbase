    ...
    implements java.io.Serializable, java.lang.Comparable
{
     ...
     */
    private static final long serialVersionUID = -4146116468309472933L;

    /**
     * 
     */
    public static final UserLocationStatus ACTIVE = new UserLocationStatus("ACTIVE");

    /**
     * 
     */
    public static final UserLocationStatus CLOSED = new UserLocationStatus("CLOSED");

    private java.lang.String value;

    private UserLocationStatus(java.lang.String value)
    {
        this.value = value;
    }
    ...
    /**
     * Creates an instance of UserLocationStatus from <code>value</code>.
     *
     * @param value the value to create the UserLocationStatus from.
     */
    public static UserLocationStatus fromString(java.lang.String value)
    {
        final UserLocationStatus typeValue = (UserLocationStatus)values.get(value);
        if (typeValue == null)
        {
    ...
    {
        return (this == that) ? 0 : this.getValue().compareTo(((UserLocationStatus)that).getValue());
    }
    ...
    {
        return (this == object)
            || (object instanceof UserLocationStatus && ((UserLocationStatus)object).getValue().equals(
                this.getValue()));
    }
    ...
    {
        return UserLocationStatus.fromString(this.value);
    }
